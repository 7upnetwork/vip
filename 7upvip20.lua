...
function Abm()
  ...
  gg.searchNumber("3.5;1;20", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  gg.getResults(850)
  gg.editAll("999", gg.TYPE_FLOAT)
  gg.clearResults()
...
- Fix Body Color
- Fix Wallhack 400+
- Fix Antena Perfect [Universal]
- Fix No Recoil (New Value)
- Fix Bullet Tracking (No Risk)
