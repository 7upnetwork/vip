...
Always check all features you need to see the updating function.
...
- Improve UI
- Added New Bypass
- Added Antena Perfect
- Remove All Antena 
- Fix Magic Bullet Super
- Fix No Recoil
- Fix AimBot Medium
- Fix Black Sky SD 400+
...
Activate this feature on your favorite weapon only.]])
  SevenUP2 = gg.multiChoice({
    ...
    "\240\159\148\185 Magic Bullet v1\n     \227\128\152Lobby\227\128\153",
	"\240\159\148\185 Magic Bullet v2\n     \227\128\152Lobby\227\128\153",
	"\240\159\148\185 Magic Bullet Super\n     \227\128\152Lobby\227\128\153",
...
function Mb1()
  ...
  gg.clearResults()
  gg.toast("Magic Bullet v1 Actived!")
end
function Mb2()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
