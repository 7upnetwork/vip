...
function Lan()
  SevenUP3 = gg.multiChoice({
    ...
    "\240\159\147\130 Weapon",
    "\240\159\147\130 Headshot",
    "\240\159\147\130 Antena",
    "\240\159\147\130 Scope",
...
function Ant()
  An = gg.multiChoice({
    ...
    "\226\172\133\239\184\143 Back"
  }, nil, "\226\154\153\239\184\143 Antena Menu")
  if An[1] == true then
    ANew()
  end
  if An[2] == true then
...
Don't change weapons too often, activate this feature on your favorite weapon only.]])
...
function Sco()
  Scp = gg.choice({
    ...
    "\240\159\148\185 OFF Scope 4X",
    "\240\159\148\185 Scope 8X",
    "\240\159\148\185 OFF Scope 8X",
    "\226\172\133\239\184\143 Back"
  }, nil, "\226\154\153\239\184\143 Scope Menu")
  if Scp == 1 then
    z4x()
  end
  if Scp == 2 then
