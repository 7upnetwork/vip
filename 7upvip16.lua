...
Activate no recoil every pick up/change weapons.]])
  SevenUP2 = gg.multiChoice({
    "\240\159\148\185 Undetect Value Changes\n     \227\128\152Lobby - Every\227\128\153",
    ...
    "\240\159\148\185 Magic Bullet (Not Safe)\n     \227\128\152Lobby/Landing\227\128\153",
	"\240\159\148\185 Bullet Tracking\n     \227\128\152Lobby\227\128\153",
	"\240\159\148\185 No Recoil\n     \227\128\152Landing - Every\227\128\153",
	"\240\159\148\185 No Recoil (Sanhok)\n     \227\128\152Landing - Every\227\128\153",
...
function Al()
  ...
  gg.clearResults()
  gg.searchNumber("3F", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
function Mb081()
  ...
  gg.clearResults()
  gg.toast("Magic Bullet 0.8.1 Actived!")
end
function Mb2()
  gg.clearResults()
  gg.setRanges(gg.REGION_ANONYMOUS)
...
function WeaAnt()
  Weapon = gg.multiChoice({
  	"\240\159\148\185 Antena Perfect",
...
version 1.6
- Fix New Bypass
- Fix Antena Perfect (Safe)
- Fix WH 425
- Fix Wallhack Clarity
- Fix No Recoil
- Fix Black Land
- Fix AimBot Hard (Work)

- Added Undetect Value Changes
- Added No Grass v2
- Added Black Sky 425 v2
- Added WH 710
- Added Antema Bullet 5.56mm
