...
Activate no recoil every pick up/change weapons.]])
  SevenUP2 = gg.multiChoice({
	...
	"\240\159\148\185 AimBot Crazy (Not Safe)\n     \227\128\152Lobby\227\128\153",
...
version 1.6.3
- Added AimBot Crazy [BETA] may not safe, please test using guest account.
- Added WH Ultimate Pro (Optional for SD 345-660)
- Fixed WH 636
- Fixed Black Sky v2 (SD 400+)


SAFE FEATURE (SANHOK) :
- Undetect Value Changes
- Antena Perfect
- Wallhack + Color
- No Recoil (Sanhok)]])
end
