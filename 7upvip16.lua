...
- No Recoil (Safe)
- Black Sky (Safe)
- Other Features (TAKE YOUR OWN RISK!)

Update 1.5.1 (0.8.0) :
- Fix AimBot Head
- Fix Magic Bullet (Safe)
- Fix Color B/W (Activate Lobby)
