...
function Lob()
  SevenUP2 = gg.multiChoice({
    ...
    "\240\159\148\185 No Recoil V2 (All Gun)\n \227\128\152Landing - Every\227\128\153",
...
function Lifs()
  God = gg.multiChoice({
    "\240\159\148\185 God Eyes ON",
    "\240\159\148\185 God Eyes OFF",
...
function Chl()
  gg.alert("\240\159\147\140 Changelog :\n\nversion 2.4\n- Fix AimBot\n- Fix Headshot 80%")
end
function Cp()
  TC = gg.choice({
